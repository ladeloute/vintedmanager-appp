...
import ArticleDescriptionGenerator from "@/pages/article-description-generator";
...
function App() {
  ...
  const renderContent = () => {
    if (currentPage === "article-description-generator") {
      return <ArticleDescriptionGenerator onBack={() => setCurrentPage("main")} />;
    }
    ...
    switch (activeTab) {
      ...
      case "articles":
        return <ArticleManagement onNavigateToDescriptionGenerator={() => setCurrentPage("article-description-generator")} />;
      default:
        return <Dashboard />;
    }
  };
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        {currentPage === "article-description-generator" ? (
          renderContent()
        ) : (
